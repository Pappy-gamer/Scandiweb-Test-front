        ...
        {this.props.inStock ? (
          <>
            <div
              ...
              key={this.props.name}
            >
              <a href={this.props.link} id="productLink">
                <img
                  id={this.props.productData}
                  src={this.props.image}
                  alt={this.props.inStock}
                />
                <div className="description" id={this.props.swatch}>
                  <h2 className="card-name">
                    {this.props.brand} {this.props.name}
                  </h2>
                  <p className="card-price" id={this.props.hasColor}>
                    {this.props.hasColor && (
                      <div style={{ marginBottom: 9 }} className="swatch">
                        <button
                          ID={this.props.swatch[0].value}
                          style={{
                            marginRight: 3,
                            width: 20,
                            height: 20,
                            backgroundColor: this.props.swatch[0].value,
                          }}
                        ></button>

                        <button
                          ID={this.props.swatch[1].value}
                          style={{
                            marginRight: 3,
                            width: 20,
                            height: 20,
                            backgroundColor: this.props.swatch[1].value,
                          }}
                        ></button>

                        <button
                          ID={this.props.swatch[2].value}
                          style={{
                            marginRight: 3,
                            width: 20,
                            height: 20,
                            backgroundColor: this.props.swatch[2].value,
                          }}
                        ></button>

                        <button
                          ID={this.props.swatch[3].value}
                          style={{
                            marginRight: 3,
                            width: 20,
                            height: 20,
                            backgroundColor: this.props.swatch[3].value,
                          }}
                        ></button>

                        <button
                          ID={this.props.swatch[4].value}
                          style={{
                            marginRight: 3,
                            width: 20,
                            height: 20,
              ...
              >
                <span className="container">
                  <img
                    ...
                    alt={this.props.inStock}
                  />
                  <p className="centered">OUT OF STOCK</p>
                </span>
                <div className="description" id={this.props.swatch}>
                  <h2 className="card-name">
                    {this.props.brand} {this.props.name}
...
export default connect(null, mapDispatchToProps())(CardListAll);
